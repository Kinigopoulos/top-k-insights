...
public class LastPointInsight extends SinglePointInsight {


    public LastPointInsight() {
    ...
    public double getSignificance(Map<DataType<?>, Double> F) {
        try {
            ...
            final double min = sortedValues.remove(sortedValues.size() - 1);
            if (min == sortedValues.get(0)) {
                return .0;
            }
